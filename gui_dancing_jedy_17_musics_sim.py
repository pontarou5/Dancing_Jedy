...
def setup_dance_scripts(music_name):
    ...
    subprocess.Popen(["gnome-terminal", "--", "bash", "-c", f"roseus jedy_dance_subscribe_{music_name}.l; exec bash"])
    subprocess.Popen(["gnome-terminal", "--", "bash", "-c", f"roseus wheel_move_dance_{music_name}.l; exec bash"])
