...
def old_generate_robot_dance_fixed_pattern(beat_times, head_ud_pose_segment, head_lr_pose_segment, left_arm_pose_segment, right_arm_pose_segment, invalid_move):
...
beat_pose_dictionary = generate_robot_dance_fixed_pattern(beat_times, head_ud_pose_segment, head_lr_pose_segment, left_arm_pose_segment, right_arm_pose_segment, invalid_move)
